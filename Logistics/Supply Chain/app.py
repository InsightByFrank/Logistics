...
POWERBI_EMBED_URL = (
    "https://app.powerbi.com/view?r=eyJrIjoiYzYxNjU3ZmMtNTk5Mi00MjFlLWExZGEt"
    "MDVlM2FiNDYwZGY3IiwidCI6IjI2YmZiMzM1LWVmNGYtNDNkOC05ODljLWIzYTVhMTNi"
    "NzUwNCJ9"
)
...
def render_overview(regression_model, classification_model, feature_columns, risk_threshold: float) -> None:
    page_header(
        ...
        "From Power BI to Predictive Decision Support",
        "This application extends the logistics Power BI analysis with a machine-learning "
        "layer that estimates customs clearance time and identifies shipments with a higher "
    ...
    render_card(
        ...
        "The Power BI layer provides visibility into historical shipment, carrier, customer, "
        "and trade performance. This application adds the predictive layer by estimating "
        "customs clearance time and identifying shipments that may require earlier "
        "operational attention.<br><br>"
        "The objective is to move from simply understanding what happened to supporting "
        "earlier decisions about where attention may be needed."
    )
